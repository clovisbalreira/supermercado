<?php
    ...
    function botaoTabelaDeletar($codigo, $variavel, $codigoInput, $variavelInput){
        return "
            <form action='#' method='get'>
                <input type='hidden' name='$codigoInput' value='$codigo'>	
                <input type='hidden' name='$variavelInput' value='$variavel'>
